...
1) **Prior**: the results in each state from the previous general election, adjusted by swings between previous national election results and current national polls;
